      ...
      <div className="relative">
        {type === "textarea" ? (
          <textarea
            ...
            onBlur={onBlur}
            rows={rows}
            className={`block w-full px-4 py-3 rounded-lg border resize-none min-h-[150px] ${
              error
                ? "border-red-300 bg-red-50"
                : "border-gray-300 focus:border-blue-500"
            } focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors duration-200`}
            ...
            <div className="animated fadeIn">
              ...
              <div className="space-y-1">
                ...
                <div className="col-span-1 md:col-span-2">
                  <p className="block text-xs text-gray-500 text-right -mb-5 mr-4">
                    {formData.ngoDescription.length}/300 characters
                  </p>
                  <InputField
                    label="NGO Description (Optional)"
                    name="ngoDescription"
                    type="textarea"
                    rows={4}
                    maxLength={300}
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    placeholder="Tell us briefly about your NGO's mission, goals or areas of focus..."
                    error={
                      touched.ngoDescription ? errors.ngoDescription : null
                    }
                  />
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="w-full md:w-1/2">
                    <InputField
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      placeholder="e.g., https://yourngo.org"
                      required
          ...
          {step === 2 && (
            <div className="animated fadeIn">
              ...
              <InputField
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                placeholder="Enter your apartment, building or locality"
                error={
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <InputField
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  placeholder="Enter a nearby location or landmark"
                  error={
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-yellow-700">
                        Please select the type of emergency resources your NGO
                        provides.
                      </p>
                    </div>
                  </div>
